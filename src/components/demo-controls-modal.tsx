...
export function DemoControlsModal({
  ...
  const [counts, setCounts] = useState({ consultants: 0, contentItems: 0, conferences: 0, guestEmails: 0, rsvps: 0 });
    ...
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        ...
        <div className="grid grid-cols-2 gap-2 my-4">
          ...
          <Button variant="outline" onClick={handleSimulateNotification}><BellPlus /> Simulate Notification</Button>
