...
import { HelpCircle, CalendarClock, User, Wallet, Tv, Languages, Shield, Wrench, Search, Mail, BookOpen } from "lucide-react";
...
const visitorTopics = [
    ...
    { id: "faq-content", href: "#faq-content", title: "Content Hub", description: "Find articles, podcasts, and manage your bookmarks.", icon: BookOpen },
...
const consultantTopics = [
    ...
    { id: "faq-content-consultant", href: "#faq-content-consultant", title: "Publishing Content", description: "Submit articles/podcasts and understand the approval flow.", icon: BookOpen },
